...
function Home({t,w,lang}) {
  return <>
    <section className="home-hero"><Photo src="bg-home.webp" alt="Suvarnabhumi Ville Hotel" eager /><div className="hero-shade" /><div className="home-hero-content wrap"><p className="eyebrow pale">THE PERFECT PLACE WITH A PERFECT VIEW</p><h1>{w.hero}</h1><p>{w.heroBody}</p><div className="actions"><External href={BOOK}>{t.navBook}</External><a href="#stay" className="button outline-light">{w.stay}<ArrowRight size={17} /></a></div></div><span className="hero-side" aria-hidden="true">A PAUSE BETWEEN DESTINATIONS</span></section>
