...
function Home({t,w,lang}) {
  return <>
    ...
    <section className="section wrap introduction"><div className="intro-images"><Photo src="fac-pool.jpg" alt={t.facPool} /><Photo src="s64-1.jpg" alt="Sky Bar 64" /><div className="hotel-logo-seal"><img src="./logo-large.png" alt="Suvarnabhumi Ville" loading="lazy" /></div></div><div className="intro-copy"><p className="eyebrow">{w.welcome}</p><h2>{w.intro}</h2><span className="gold-rule" /><p className="muted">{w.introBody}</p></div></section>
